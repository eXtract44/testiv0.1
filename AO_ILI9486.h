...
void ILI9486_drawPixel(uint16_t x, uint16_t y, uint16_t color); //Draw single pixel to ILI9486
//6. Fill the entire screen with a background color
void ILI9486_Fill(uint16_t color); //Fill entire ILI9486 with color
...
void TFT9486_string(uint16_t x,uint16_t y, char *str);
